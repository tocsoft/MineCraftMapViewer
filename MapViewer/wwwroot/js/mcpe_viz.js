    ...
    if (enableFlag) {
        if (layerShadedReliefStatic === null) {
            ...
            if (useTilesFlag) {
                ...
                var opacityControl = $('#elevationStaticOpacity');
                var opacity = 30;
                if (opacityControl.length > 0) {
                    opacity = opacityControl.val();
                }
...
$(function () {
    ...
    var updateElevationStaticOpacity = function () {
        ...
        $('#elevationStaticOpacityOut').html(opacity);
        if (layerShadedReliefStatic !== null) {
            layerShadedReliefStatic.setOpacity(opacity / 100.0);
        }
    };
